...
SECRET_KEY = 'django-insecure-4x8@2s7^y+e3b#z0p$w!6g)mn*qf1j_r@h&d%-xk(9u^o=b1%3'
...
MIDDLEWARE = [
    ...
    'shop.middleware.ForceEnglishMiddleware',  # Add your middleware here
    'django.middleware.locale.LocaleMiddleware',
]

# settings.py
LANGUAGE_CODE = 'en-us'
USE_L10N = False  # Disable localization to ensure consistent number formatting
